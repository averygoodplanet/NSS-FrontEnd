...
function clickAddStudent() {
  ...
  //create a student and add to school.students
...
function School(name, length, width) {
  // "this" refers to itself, i.e. School.name;
  this.name = name;
  this.established = '1930';
  this.length = length;
  this.width = width;
  this.students = [];
  //making the area value "live" throught creating a function.
  //to get area call this.area()  the parentheses.
